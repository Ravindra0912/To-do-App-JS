...
/*!*******************************!*\
  !*** ./src/helpers/helper.js ***!
  \*******************************/
/*! exports provided: getSublistItemHTML, renderSublist */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getSublistItemHTML\", function() { return getSublistItemHTML; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"renderSublist\", function() { return renderSublist; });\nfunction getSublistItemHTML(id, value) {\n  return `<li id=${id} class = \"sub-list-items\" contentEditable=\"true\"><span>${value}</span><button  id=\"save-changes\">Save</button> <button id=\"delete-sublist\">delete</button></li>`;\n}\n\nfunction renderSublist(curr) {\n  let markup = getSublistItemHTML(curr.id, curr.value);\n  document\n    .querySelector('.sub-list-items')\n    .insertAdjacentHTML('beforeend', markup);\n}\n\n// export default getSublistItemHTML;\n\n\n//# sourceURL=webpack:///./src/helpers/helper.js?");
